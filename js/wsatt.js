...
rel = [
  document.querySelectorAll('#day0 .blocklist.right .libero input'),
  document.querySelectorAll('#day1 .blocklist.right .libero input'),
  document.querySelectorAll('#day2 .blocklist.right .libero input')
];
lel = [
  document.querySelectorAll('#day0 .blocklist.left .libero input'),
  document.querySelectorAll('#day1 .blocklist.left .libero input'),
  document.querySelectorAll('#day2 .blocklist.left .libero input')
];
